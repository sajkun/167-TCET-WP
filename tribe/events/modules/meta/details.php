...
<div class="tribe-events-meta-group tribe-events-meta-group-details">
	...
	<h2 class="single-event-meta-title"> <?php esc_html_e( 'Details', 'the-events-calendar' ); ?> </h2>
	<dl>
		...
		<div class="event-meta-text">
			<?php echo esc_html( $start_datetime->format('F d, Y')); ?>
		</div>

			<dt class="tribe-events-start-date-label"> </dt>
			<dd>
				<abbr class="tribe-events-abbr tribe-events-start-date published dtstart" title="<?php echo esc_attr( $start_ts ); ?>">  </abbr>
			</dd>
